...
const b2cConfig = {
  policyAuthorities: {
    signUpSignIn: import.meta.env
      .VITE_AZUREADB2C_SIGN_IN_POLICY_AUTHORITY as string,
  },
...
const apiScopes = [
  `${b2cConfig.apiApplicationIdUrl}/Api.Read`,
  `${b2cConfig.apiApplicationIdUrl}/Api.Write`,
]
